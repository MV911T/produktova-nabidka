...
Dvě příčiny, obě doložené na návrzích textů (viz 30):
...
**15.** Kontrola tvrzení proti Vodítkům SZPI 2024 — tři vrstvy (dnes čtyři, viz 25):
...
**21.** 79 testů bez přístupu na síť, `ruff` bez nálezů
...
**30.** Náhradní znění pro texty, které kontrola označila. Deset míst
